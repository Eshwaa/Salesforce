...
public class Opportunities {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("(//div[@class='slds-form-element__control slds-grow'])[3]/input")).sendKeys("Salesfource automated by eshwaa");
		
		driver.findElement(By.xpath("(//div[@class='slds-form-element__control slds-input-has-icon slds-input-has-icon_right'])/input")).sendKeys("06/06/2023");
